...
var strings = {
  get notSupportedForProcessing() {
    return "Value is not supported within a declarative processing context, if you want it to be supported mark it using WinJS.Utilities.markSupportedForProcessing. The value was: '{0}'";
  }
};
...
var platform = _Global.navigator ? _Global.navigator.platform : undefined;
...
function getCamelCasedName(styleName) {
  ...
  return styleName.replace(/\-[a-z]/g, function(x) {
...
_Base.Namespace._moduleDefine(exports, "WinJS.Utilities", {
  ...
  hasWinRT: {
    get: function() {
      return _BaseCoreUtils.hasWinRT;
    },
    configurable: false,
    enumerable: true
  },
  ...
  ready: function ready(callback, async) {
    ...
    return new Promise(function(c, e) {
      ...
      var readyState = (<any>ready)._testReadyState;
      if (!readyState) {
        if (_Global.document) {
